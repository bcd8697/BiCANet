...
class CCPB(tf.keras.layers.Layer):
  ...
  def __init__(self):
    ...
    self.conv_in = layers.Conv2D(filters = 12, kernel_size = 1, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
    
    self.conv1_branch1 = layers.Conv2D(filters = 4, kernel_size = 1, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
    self.conv1_branch2 = layers.Conv2D(filters = 4, kernel_size = 1, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
    self.conv1_branch3 = layers.Conv2D(filters = 4, kernel_size = 1, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')

    self.conv3_branch21 = layers.Conv2D(filters = 4, kernel_size = 3, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
    self.conv3_branch31 = layers.Conv2D(filters = 4, kernel_size = 3, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
    self.conv3_branch32 = layers.Conv2D(filters = 4, kernel_size = 3, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')

    self.conv_out = layers.Conv2D(filters = 1, kernel_size = 1, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform')
...
class MCFB(tf.keras.layers.Layer):
  ...
  def __init__(self, img_width, img_height):
    ...
    self.conv_3x3 = layers.Conv2D(filters = 1, kernel_size = 3, padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform') 
    self.conv_1xK = layers.Conv2D(filters = 1, kernel_size = (1,5), padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform') 
    self.conv_Kx1 = layers.Conv2D(filters = 1, kernel_size = (5,1), padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform') 
    ...
    self.conv_1xM = layers.Conv2D(filters = 1, kernel_size = (1, self.M), padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform') 
    self.conv_Mx1 = layers.Conv2D(filters = 1, kernel_size = (self.M, 1), padding = 'same', activation = 'relu', kernel_initializer = 'he_uniform') 
